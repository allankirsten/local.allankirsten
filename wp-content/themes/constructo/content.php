...
if(is_sticky(get_the_ID())) {
    ...
    $post_data .= "<ul>";
    $post_data .= "<li><i class='hovercolor fa fa-comment-o'></i><a href='".get_permalink()."#comments'>".get_comments_number()." ".__("comments", 'constructo')."</a></li>";
    $post_data .= "<li><i class='hovercolor fa fa-folder-o'></i>";
    $first_item = false;
    ...
    $post_data .= "</li>";
    $post_data .= "<li><i class='hovercolor fa fa-user'></i>".__("posted by", 'constructo')." <a href='".get_author_posts_url(get_the_author_meta('ID'))."' class='author'>".get_the_author()."</a></li>";
    $post_data .= "<li><i class='hovercolor fa fa-calendar'></i>".get_the_date()."</li>";
    $post_data .= "</ul>";
    $post_data .= "</div>";
    $post_data .= "</header>";
