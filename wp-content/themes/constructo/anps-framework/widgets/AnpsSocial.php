...
html_entity_decode("&#xf266; ") . __(" wikipedia-w ", 'constructo')=>" wikipedia-w "
        ...
        <p>
            ...
            <select class="anps_widget_fontawesome anps_select2 addsel" id="<?php echo $anps_select_id_social; ?>" name="<?php echo esc_attr($this->get_field_name('icon_'.$i)); ?>">
                <?php //$anps_select_id = $this->get_field_id('icon_'.$i); 
                var_dump($anps_select_id_social);?>
