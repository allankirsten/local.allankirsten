...
if($blog_columns==" col-sm-3") {
    $image_class = "blog-masonry-3-columns";
    $blog_col_num = 4;
} elseif($blog_columns==" col-sm-4") {
    $image_class = "blog-masonry-3-columns";
    $blog_col_num = 3;
} 
$sticky_class = "";
...
if(anps_header_media(get_the_ID(), "blog-grid")!="") {
	...
	$post_data .= "<span>".get_the_date()."</span> / <span>".get_comments_number()." ".__("comments", 'constructo')."</span>";
	$post_data .= "</header>";
	...
	$post_data .= "<span>".get_the_date("j / m / Y")."</span> / <span>".get_comments_number()." ".__("comments", 'constructo')."</span>";
	$post_data .= "</header>";
    $post_data .= "<div class='post-content'>".$content_text."</div>"; 
    $post_data .= "</div>";
}
